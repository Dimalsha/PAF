...
<body>
	...
	try{
		...
		shipnum = request.getParameter("shipnum");
		...
		%>
			<form action = "entry/ship/updateShip" method = "POST">
			<input type="hidden" name="shipname" value = "<%=shipname %>"/>
			<h3>Address : <input type="text" name="shipaddress" value = "<%=shipaddress%>" required/></h3><br/>
			<h3>Contact Number : <input type="text" name="contactnumber" value = "<%=shipnum%>" required/></h3><br/>
