...
<div id="top-bar" class="container">
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">
				<!-- Main Content -->
				<form style = "text-align: center" action="entry/ship/Register" method="POST">
					<h1>Add Shipping Companies</h1>
					<label>Company Picture:</label><input type="file" name="shippic"  required>
					<label>Company Name:</label> <input type="text" name="shipname" required/><br/>
					<label>Address:</label> <input type="text" name="shipaddress" required/><br/>
					<label>Contact Number:</label> <input type="text" name="shipnum" required/><br/>
				    <br/>
				<br/>
