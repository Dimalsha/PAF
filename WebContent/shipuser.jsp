...
<body>
	%
String un1=(String)session.getAttribute("un1");
				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">
							...
							<li><a href="orderprofile.jsp">Your Cart</a></li>
...
%>
                   ...
                   <tbody>
                    <tr>
                    <td><img width=80px height=50px  border="3" style = "border-color:  "src="<%=resultSet.getString("shippic") %>"></td>
                       <td><%=resultSet.getString("shipname") %></td>
                      <td><%=resultSet.getString("shipaddress") %></td>
                      <td><%=resultSet.getString("shipnum") %></td>
